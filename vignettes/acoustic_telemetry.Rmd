...
Connect with your user credentials (as received by VLIZ) to the database. You can store these by use of [environment variables](https://db.rstudio.com/best-practices/managing-credentials/#use-environment-variables), or alternativly, functions that require a database connection will prompt you for this information the first time you use them per session.
