...
Functions in etn need user credentials to connect to the database. You should have received those from VLIZ. You will be prompted (once per session) for these credentials. To avoid this you can save them as [environment variables](https://db.rstudio.com/best-practices/managing-credentials/#use-environment-variables).
...
```
## file:////tmp/RtmpEKn5NP/filea35c1130b7cd/widgeta35c27e179fc.html screenshot completed
```

![plot of chunk map_stations](figure/map_stations-1.png)
...
```
## file:////tmp/RtmpEKn5NP/filea35c167f3d55/widgeta35c33bae59f.html screenshot completed
```

![plot of chunk leaflet_n_detections_Wels_catfish](figure/leaflet_n_detections_Wels_catfish-1.png)
...
```
## file:////tmp/RtmpEKn5NP/filea35c4b890f6/widgeta35c3b12bdf1.html screenshot completed
```

![plot of chunk map_n_individuals_per_station](figure/map_n_individuals_per_station-1.png)
...
```
## file:////tmp/RtmpEKn5NP/filea35c4ff4eacb/widgeta35c60a0a6ab.html screenshot completed
```

![plot of chunk map_rel_detection_duration_deploys](figure/map_rel_detection_duration_deploys-1.png)
