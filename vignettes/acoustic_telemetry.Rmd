...
Let's say we are interested in the tracking data of Wels catfish (_Silurus glanis_) between begin 2014 and end 2015. You can retrieve the detection history by `get_acoustic_detections()`:
...
We start creating a map of the involved stations showing the station name and the acoustic project code it belongs to as pop-up. First, we have to retrieve the station geographical coordinates:
...
And then we add them on a map showing the station name and the acoustic project code they belong to: 
