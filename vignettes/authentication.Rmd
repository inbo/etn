...
1. [Register for a MarinePass account](https://rshiny.lifewatch.be/account?p=register). It grants you access to several services at VLIZ: [MDA](https://mda.vliz.be/), [ETN](https://www.lifewatch.be/etn/), and the [VLIZ RStudio server](https://rstudio.lifewatch.be).
