...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  eval = FALSE # Don't run code (it will only work on rstudio server with access to etn)
)
```
...
knitr::kable(head(my_projects, 10)) # print 10 first
```
...
knitr::kable(head(my_network_projects, 10)) # print 10 first
```
...
knitr::kable(head(ws3_receivers, 10)) # print 10 first
```
...
knitr::kable(head(ws_receivers, 10)) # print 10 first
```
...
knitr::kable(head(my_deployments, 10)) # print 10 first 
```
...
knitr::kable(head(my_animals, 10)) # print 10 first
```
...
knitr::kable(head(my_tags, 10)) # print 10 first
```
...
knitr::kable(head(my_detections, 10)) # print 10 first
```
