...
* `connect_to_etn()` is no longer neccesairy and is deprecated as of this version. All functions will create their own connection when used. If you have no credentials stored in the system environement, the functions will require you to enter them once per session.
