...
* New `get_package()` gets all acoustic data realted to an animal project as a Frictionless Data Package (#544).
* New `add_resource()` adds ETN data as a Data Resource to a Frictionless Data Package. The function extends `frictionless::add_resource()` (#544).
