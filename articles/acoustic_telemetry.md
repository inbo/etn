...
Functions in etn need user credentials to connect to the database. You
should have received those from VLIZ. You will be prompted (once per
session) for these credentials. To avoid this you can save them as
[environment
variables](https://db.rstudio.com/best-practices/managing-credentials/#use-environment-variables).
