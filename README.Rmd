...
The ETN infrastructure currently requires the package to be run within the [VLIZ RStudio server](http://rstudio.lifewatch.be/), which is password protected. A login can be requested at http://www.lifewatch.be/etn/contact.
