...
Before you can access data from the European Tracking Network, you need to request a login from the Flanders Marine Institute (VLIZ). A detailed description on how to do this can be found in the vignette on `vignette("authentication")`. 
