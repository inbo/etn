...
The ETN infrastructure currently requires the package to be run within the [VLIZ RStudio server](https://rstudio.lifewatch.be/), which is password protected. A login can be requested at https://www.lifewatch.be/etn/contact.
