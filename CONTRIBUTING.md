...
First of all, thanks for considering contributing to etn! 👍 It’s people
like you that make it rewarding for us - the project maintainers - to
work on etn. 😊

etn is an open source project, maintained by people who care. We are not
directly funded to do so.
...
Think etn is useful? Let others discover it, by telling them in person,
via Twitter or a blog post.

Using etn for a paper you are writing? Consider [citing
it](https://inbo.github.io/etn/authors.html).

### Ask a question ⁉️

Using etn and got stuck? Browse the
[documentation](https://inbo.github.io/etn) to see if you can find a
solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/inbo/etn/issues/new). While we cannot offer
user support, we’ll try to do our best to address it, as questions often
lead to better documentation or the discovery of bugs.
...
Have an idea for a new etn feature? Take a look at the
[documentation](https://inbo.github.io/etn) and [issue
list](https://github.com/inbo/etn/issues) to see if it isn’t included or
suggested yet. If not, suggest your idea as an [issue on
GitHub](https://github.com/inbo/etn/issues/new). While we can’t promise
...
Using etn and discovered a bug? That’s annoying! Don’t let others have
the same experience and report it as an [issue on
GitHub](https://github.com/inbo/etn/issues/new) so we can fix it. A good
bug report makes it easier for us to do so, so please include:
...
[This website](https://inbo.github.io/etn) is generated with
...
issue](https://github.com/inbo/etn/issues/new) and we can point you in
the right direction.
...
1.  Go to `R/` directory in the [code
    repository](https://github.com/inbo/etn).
...
Care to fix bugs or implement new functionality for etn? Awesome! 👏
Have a look at the [issue list](https://github.com/inbo/etn/issues) and
...
1.  Fork [this repo](https://github.com/inbo/etn) and clone it to your
    computer. To learn more about this process, see [this
