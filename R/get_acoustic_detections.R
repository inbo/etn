...
get_acoustic_detections <- function(connection = con,
  ...
  query <- glue_sql("
    ...
    SELECT
      ...
      deployment.station_name AS station_name, -- Not det.station_name
      deployment.deploy_lat AS deploy_latitude, -- Not det.latitude
      deployment.deploy_long AS deploy_longitude, -- Not det.longitude
      ...
      -- det.gain
      -- external_id
    FROM acoustic.detection AS det
