...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 235.81 k detections [8.7s]
#> 
#> Getting detections. ■■■■■■■■■■■                       33% [7.1s] | ETA: 14s
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [14.8s] | ETA:  7s
#> ℹ Wrapping up
#> ✔ Wrapping up [383ms]
#> 
#> # A tibble: 235,809 × 20
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [3.8s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [58ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [4.6s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [59ms]
#> 
