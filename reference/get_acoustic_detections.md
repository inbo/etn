...
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [11.6s] | ETA:  6s
#> ℹ Wrapping up
#> ✔ Wrapping up [399ms]
#> 
#> # A tibble: 235,809 × 20
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 23.70 k detections [11.2s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [110ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [2.6s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [55ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [1.6s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [55ms]
#> 
