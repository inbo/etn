...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 235.81 k detections [8.1s]
#> 
#> Getting detections. ■■■■■■■■■■■                       33% [7.5s] | ETA: 15s
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 23.70 k detections [3s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [114ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [6.3s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [57ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [5.6s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [55ms]
#> 
