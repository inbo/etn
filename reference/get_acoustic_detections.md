...
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [11.4s] | ETA:  6s
#> ℹ Wrapping up
#> ✔ Wrapping up [382ms]
#> 
#> # A tibble: 235,809 × 20
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 23.70 k detections [2.3s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [117ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [2.4s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [61ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [2.1s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [58ms]
#> 
