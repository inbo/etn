...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 235.81 k detections [4.5s]
#> 
#> Getting detections. ■■■■■■■■■■■                       33% [23.7s] | ETA: 47s
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [50.9s] | ETA: 25s
#> ℹ Wrapping up
#> ✔ Wrapping up [373ms]
#> 
#> # A tibble: 235,809 × 20
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 23.70 k detections [9.7s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [111ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [11.9s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [57ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 2  detections [11.5s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [56ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 50  detections [20s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [52ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [27.7s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [56ms]
#> 
