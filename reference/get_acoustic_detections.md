...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 235.81 k detections [1.9s]
#> 
#> Getting detections. ■■■■■■■■■■■                       33% [5.7s] | ETA: 11s
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [11s] | ETA:  5s
#> ℹ Wrapping up
#> ✔ Wrapping up [387ms]
#> 
#> # A tibble: 235,809 × 20
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 23.70 k detections [8s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [114ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [2.1s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [56ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 50  detections [1.6s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [54ms]
#> 
