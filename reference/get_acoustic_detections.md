...
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [12.5s] | ETA:  6s
#> ℹ Wrapping up
#> ✔ Wrapping up [385ms]
#> 
#> # A tibble: 235,809 × 20
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 23.70 k detections [3.2s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [112ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 50  detections [1.9s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [56ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [1.9s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [58ms]
#> 
