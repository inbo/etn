...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 235.81 k detections [2.2s]
#> 
#> Getting detections. ■■■■■■■■■■■                       33% [6.4s] | ETA: 13s
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [12.7s] | ETA:  6s
#> ℹ Wrapping up
#> ✔ Wrapping up [392ms]
#> 
#> # A tibble: 235,809 × 20
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 23.70 k detections [2.1s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [143ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [2s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [56ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 50  detections [2.2s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [59ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [1.4s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [58ms]
#> 
