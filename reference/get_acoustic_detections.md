...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 235.81 k detections [6.3s]
#> 
#> Getting detections. ■■■■■■■■■■■                       33% [7.1s] | ETA: 14s
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [14.6s] | ETA:  7s
#> ℹ Wrapping up
#> ✔ Wrapping up [383ms]
#> 
#> # A tibble: 235,809 × 20
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [2.7s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [63ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 2  detections [2.5s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [59ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 50  detections [2.5s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [59ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [3.9s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [61ms]
#> 
