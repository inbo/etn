...
#> 
#> Getting detections. ■■■■■■■■■■■                       33% [8.5s] | ETA: 17s
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [17.4s] | ETA:  9s
#> ℹ Wrapping up
#> ✔ Wrapping up [396ms]
#> 
#> # A tibble: 235,809 × 20
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 23.70 k detections [3.8s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [105ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 2  detections [4.5s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [55ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [2.3s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [55ms]
#> 
