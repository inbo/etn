...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 100  detections [14ms]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [115ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 235.81 k detections [7.4s]
#> 
#> Getting detections. ■■■■■■■■■■■                       33% [8.8s] | ETA: 18s
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [16.5s] | ETA:  8s
#> ℹ Wrapping up
#> ✔ Wrapping up [388ms]
#> 
#> # A tibble: 235,809 × 20
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [4s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [59ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 2  detections [2.8s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [65ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 50  detections [2.3s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [65ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [6.1s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [62ms]
#> 
