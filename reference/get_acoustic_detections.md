...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 100  detections [13ms]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [117ms]
#> 
...
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [14.9s] | ETA:  7s
#> ℹ Wrapping up
#> ✔ Wrapping up [399ms]
#> 
#> # A tibble: 235,809 × 20
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [6.9s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [62ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 50  detections [2.7s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [57ms]
#> 
