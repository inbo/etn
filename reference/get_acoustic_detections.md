...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 235.81 k detections [3.8s]
#> 
#> Getting detections. ■■■■■■■■■■■                       33% [7.3s] | ETA: 15s
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [13.5s] | ETA:  7s
#> ℹ Wrapping up
#> ✔ Wrapping up [357ms]
#> 
#> # A tibble: 235,809 × 20
...
#> 10     20582652 2014-04-18 15:52:33 1187449           A69-1601-16129 
#> # ℹ 235,799 more rows
#> # ℹ 16 more variables: animal_project_code <chr>, animal_id <int>,
#> #   scientific_name <chr>, acoustic_project_code <chr>, receiver_id <chr>,
#> #   station_name <chr>, deploy_latitude <dbl>, deploy_longitude <dbl>,
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [3.1s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [57ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 2  detections [2.7s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [56ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [2.8s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [56ms]
#> 
