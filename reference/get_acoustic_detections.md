...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 235.81 k detections [8.4s]
#> 
#> Getting detections. ■■■■■■■■■■■                       33% [9.2s] | ETA: 18s
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [17.9s] | ETA:  9s
#> ℹ Wrapping up
#> ✔ Wrapping up [429ms]
#> 
#> # A tibble: 235,809 × 20
...
#>  6     20582652 2014-04-18 15:52:33 1187449           A69-1601-16129 
#>  7     20627256 2014-04-18 15:51:11 1187449           A69-1601-16129 
#>  8     20734006 2014-04-18 15:50:03 1187449           A69-1601-16129 
#>  9     20744955 2014-04-18 16:01:00 1187449           A69-1601-16129 
#> 10     20777048 2014-04-18 15:55:00 1187449           A69-1601-16129 
#> # ℹ 235,799 more rows
#> # ℹ 16 more variables: animal_project_code <chr>, animal_id <int>,
#> #   scientific_name <chr>, acoustic_project_code <chr>, receiver_id <chr>,
#> #   station_name <chr>, deploy_latitude <dbl>, deploy_longitude <dbl>,
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 23.70 k detections [15.9s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [120ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [4.7s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [64ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 50  detections [3.5s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [62ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [4.2s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [62ms]
#> 
