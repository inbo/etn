...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 235.81 k detections [7.3s]
#> 
#> Getting detections. ■■■■■■■■■■■                       33% [7.3s] | ETA: 15s
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 23.70 k detections [14.2s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [117ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [5s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [59ms]
#> 
