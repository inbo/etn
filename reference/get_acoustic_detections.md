...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 100  detections [9ms]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [87ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 235.81 k detections [2.5s]
#> 
#> Getting detections. ■■■■■■■■■■■                       33% [10.6s] | ETA: 21s
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [20.8s] | ETA: 10s
#> ℹ Wrapping up
#> ✔ Wrapping up [320ms]
#> 
#> # A tibble: 235,809 × 20
...
#>  8     21655610 2014-04-18 16:02:26 1187449           A69-1601-16129 
#>  9     21676626 2014-04-18 15:45:00 1187449           A69-1601-16129 
#> 10     21745679 2014-04-18 15:47:45 1187449           A69-1601-16129 
#> # ℹ 235,799 more rows
#> # ℹ 16 more variables: animal_project_code <chr>, animal_id <int>,
#> #   scientific_name <chr>, acoustic_project_code <chr>, receiver_id <chr>,
#> #   station_name <chr>, deploy_latitude <dbl>, deploy_longitude <dbl>,
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 23.70 k detections [2.6s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [85ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [3.4s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [45ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 2  detections [2.6s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [39ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 50  detections [8.8s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [45ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [2.7s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [45ms]
#> 
