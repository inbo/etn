...
#> 
#> Getting detections. ■■■■■■■■■■■                       33% [6.9s] | ETA: 14s
#> Getting detections. ■■■■■■■■■■■■■■■■■■■■■             67% [13.2s] | ETA:  7s
#> ℹ Wrapping up
#> ✔ Wrapping up [384ms]
#> 
#> # A tibble: 235,809 × 20
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 23.70 k detections [2.2s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [116ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [1.7s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [59ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [2.9s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [58ms]
#> 
