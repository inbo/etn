...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 235.81 k detections [4.4s]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 23.70 k detections [2.9s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [116ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 442  detections [3.3s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [69ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 2  detections [3.3s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [57ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 50  detections [3.6s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [53ms]
#> 
...
#> ℹ Preparing 
#> ✔ Preparing : will fetch 38  detections [4.8s]
#> 
#> ℹ Wrapping up
#> ✔ Wrapping up [57ms]
#> 
